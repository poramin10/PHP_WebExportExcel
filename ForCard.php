...
<head>
    ...
    <title>Data Main For Card</title>
...
<body class="bg-dark">
    ...
    <div class="container">
        <div class="row" style="margin-top: 3rem">
            <div class="col-md-12">
                <div class="card">
                    <h5 class="card-header">หน้า Form การ Uplaod Data Main For Card </h5>
                    <div class="card-body">
                        <form action="php_Import.php" enctype="multipart/form-data" method="post" role="form">
                        ...
                        <table id="dataTable" class="table table-bordered table-striped table-responsive">
                            ...
                            <tbody>
                                <?php while ($row = $result->fetch_assoc()) { ?>
                                    <tr>
                                        <td><?php echo $row['RFID10digit'] ?></td>
                                        <td><?php echo "34" ?></td>
                                        <td><?php echo "1" ?></td>
                                        <td><?php echo "0" ?></td>
                                        <td><?php echo "1/1/43 " ?></td>
                                        <td><?php echo "1/1/43 " ?></td>
                                        <td><?php ?></td>
                                        <td><?php ?></td>
                                        <td><?php echo "0" ?></td>
